...
| Login | `/api/auth/login` | User authentication | Store access\_token \& refresh\_token, show Toast on failure, auto-refresh JWT |
...
\- Open solutions: `FUNewsManagement\_CoreAPI.sln`, `FUNewsManagement\_AnalyticsAPI.sln`, `FUNewsManagement\_AIAPI.sln`  
...
\- Open solution: `FUNewsManagement\_FE.sln`  
